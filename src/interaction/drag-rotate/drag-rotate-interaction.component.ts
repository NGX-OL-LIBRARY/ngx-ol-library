 ...
 * dragging on the map.
 * @name nol-drag-rotate-interaction
 * @order 1
 */
@Component({
...
export class NolDragRotateInteractionComponent
...
export function useDragRotateInteraction(): NolDragRotateInteractionComponent;
export function useDragRotateInteraction(options: InjectOptions & {optional?: false}): NolDragRotateInteractionComponent;
export function useDragRotateInteraction(options: InjectOptions): NolDragRotateInteractionComponent | null;
export function useDragRotateInteraction(options?: InjectOptions): NolDragRotateInteractionComponent | null  {
  return inject(NolDragRotateInteractionComponent, options || {}) || null;
}