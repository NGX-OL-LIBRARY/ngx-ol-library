...
export function injectVectorLayer(): NolVectorLayerComponent;
export function injectVectorLayer(options: InjectOptions & {optional?: false}): NolVectorLayerComponent;
export function injectVectorLayer(options: InjectOptions): NolVectorLayerComponent | null;
export function injectVectorLayer(options?: InjectOptions): NolVectorLayerComponent | null  {
  return inject(NolVectorLayerComponent, options || {}) || null;
}
