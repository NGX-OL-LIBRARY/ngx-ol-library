...
import { NolMultiPolygonGeometryModule } from 'ngx-ol-library/geom/multi-polygon';
...
@Component({
  selector: 'nol-multi-polygon-geometry-simple-example',
  standalone: true,
  imports: [
    NgFor,
    NolMapComponent,
  ...
  template: `
    <nol-map [nolHeight]="'400px'">
      ...
      <nol-vector-layer>
        <nol-vector-source>
          <nol-feature>
            <nol-multi-polygon-geometry [nolCoordinates]="[]">
              <ng-container *ngFor="let coordinates of listOfPolygonCoordinates">
...
export class NolMultiPolygonGeometrySimpleExampleComponent {
